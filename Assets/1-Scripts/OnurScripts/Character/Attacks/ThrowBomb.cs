...
public class ThrowBomb : CharacterAttackState
{
    ...
    public override void AttackBehaviour(CharacterStateManager character)
    {
        ...
        bomb.SetActive(true);
        Vector3 bombMovePosition = new Vector3(bomb.transform.position.x, character.transform.position.y - 3f, bomb.transform.position.z) + character.transform.forward * 15f;
